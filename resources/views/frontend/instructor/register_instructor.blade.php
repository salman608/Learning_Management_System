                            ...
                            <form method="post" action="{{ route('instructor.register') }}" class="row">
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control @error('name') @enderror" type="text"
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control @error('username') @enderror"
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control @error('email') @enderror" type="email"
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input id="phone" class="form-control form--control @error('phone') @enderror"
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control @error('address') @enderror"
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control @error('password') @enderror"
