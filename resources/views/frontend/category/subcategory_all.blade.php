        ...
        <div class="container">
            <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
                <div class="section-heading">
                    <h2 class="section__title text-white">Sub Category Wise Course</h2>
                </div>
                <ul
                        ...
                        <div class="card card-item">
                            <div class="card-body">
                                ...
                                <div class="custom-control custom-radio mb-1 fs-15">
                                    ...
                                    </label>https://www.youtube.com/watch?v=VjxaZJIBYEk
                                </div>
                                <div class="custom-control custom-radio mb-1 fs-15">
                        ...
                        @foreach ($courses as $course)
                            <div class="col-lg-6 responsive-column-half">
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                    <div class="card-image">
                                        ...
                                        <div class="course-badge-labels">
                                            ...
                                            @if ($course->highestrated == 1)
                                                <div class="course-badge green">Highestrated</div>
                                            @else
                                            @endif
                                    ...
                                    <div class="card-body">
                                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">{{ $course->lavel }}</h6>
