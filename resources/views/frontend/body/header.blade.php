                ...
                <div class="col-lg-6">
                    <div class="header-widget d-flex flex-wrap align-items-center justify-content-end">
                        ...
                        <ul
                            ...
                            @auth
                                <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i
                                        class="las la-house-damage mr-1"></i><a href="{{ route('dashboard') }}">
                                        Dashboard</a>
                                </li>
                                {{-- <i class="las la-house-damage"></i> --}}
                                <li class="d-flex align-items-center"><i class="la la-power-off mr-1"></i><a
                                    ...
                                    <li>
                                        ...
                                        <ul class="cat-dropdown-menu">
                                            @foreach ($categories as $cat)
                                                ...
                                                @endphp
                                                <li>
                                                    <a href="course-grid.html">{{ $cat->category_name }} <i
                                                            class="la la-angle-right"></i></a>
                                                    <ul class="sub-menu">
                                                        @foreach ($subcategories as $subcat)
                                                            <li><a href="#">{{ $subcat->subcategory_name }}</a>
                                                            </li>
                                                        @endforeach
